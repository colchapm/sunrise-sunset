  ...
  render() {
    ...
    if (this.state.location != null && this.state.isGifLoaded && this.state.isWeatherLoaded) {
      ...
      <React.Fragment>
        ...
        <p>Sunrise time in {this.state.location}: {this.handleSunConverter(this.state.weatherData.sys.sunrise)}</p>
        <p>Sunset time in {this.state.location}: {this.handleSunConverter(this.state.weatherData.sys.sunset)}</p>
      </React.Fragment>
    }
        return (
          <React.Fragment>
